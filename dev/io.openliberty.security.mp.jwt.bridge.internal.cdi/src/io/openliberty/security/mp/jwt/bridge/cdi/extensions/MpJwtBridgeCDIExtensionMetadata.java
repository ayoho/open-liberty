...
@Component(service = CDIExtensionMetadata.class,
           ...
           immediate = true)
public class MpJwtBridgeCDIExtensionMetadata implements CDIExtensionMetadata, CDIExtensionMetadataInternal {

    @Override
    public Set<Class<? extends Extension>> getExtensions() {
        Set<Class<? extends Extension>> extensions = new HashSet<Class<? extends Extension>>();
        extensions.add(MpJwtBridgeCDIExtension.class);
        return extensions;
    }
    ...
    public Set<Class<? extends Annotation>> getBeanDefiningAnnotationClasses() {
        ...
        // TODO
        BDAs.add(JwtAuthenticationMechanismDefinition.class);
        return BDAs;
    }
